                            ...
                            <td>
                                <div class="dropdown">
                                    ...
                                    <div class="dropdown-menu" aria-labelledby="dropdownMenuLink">
                                      <a class="dropdown-item d-flex justify-content-between" href="{{ route('admin.service.show',['service' => $item->id]) }}">
                                        <span>
                                            {{ __('show') }}
                                        </span>
                                        <span>
                                      ...
                                      <a class="dropdown-item d-flex justify-content-between" href="{{ route('admin.service.edit',['service' => $item->id]) }}">
                                        <span>
                                            {{ __('edit') }}
                                        </span>
                                        <span>
                                      ...
                                      <form class="dropdown-item" method="POST" action="{{ route('admin.service.destroy', ['service' => $item->id])}}">
                                        @csrf
                                        @method('DELETE')
